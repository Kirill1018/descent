...
public:
	...
	void data_output()
	{
		try
		{
			...
			ofile << "хлеб" << endl;
			cout << "поступление" << setw(3) << product_2.entr_per << setw(3) << "продажа" << setw(3) << product_2.sale_per << setw(3) << "списание" << setw(3) << product_2.per_of_write_downs << endl;
			...
			else ofile << "поступление" << setw(3) << product_2.entr_per << setw(3) << "продажа" << setw(3) << product_2.sale_per << setw(3) << "списание" << setw(3) << product_2.per_of_write_downs << endl;
			if (ifile.is_open())
			{
				string line;
				while (ifile >> line) cout << line << ' ';
